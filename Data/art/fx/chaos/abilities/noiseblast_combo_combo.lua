fxtypes =  
{
	...
	{
		effect = "root>noiseblast_spray_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>noiseblast_spray_combo>noiseblast_ring_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>noiseblast_spray_combo>noiseblast_ring_combo>dark_outter_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>noiseblast_spray_combo>noiseblast_ring_combo>dark_outter_ring2",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>noiseblast_spray_combo>noiseblast_ring_combo>dark_outter_ring3",
		fx =  
		{
			properties =  
			{
