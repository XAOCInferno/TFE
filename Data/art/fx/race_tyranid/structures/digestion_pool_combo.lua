fxtypes =  
{
	...
	{
		effect = "root>digestion_pool_boiling_mass",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>digestion_pool_boiling_mass>default_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "RACE_TYRANID/TEXTURES/VOID_LIGHT.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>pink_smoke>default_ring",
		fx =  
		{
			properties =  
			{
