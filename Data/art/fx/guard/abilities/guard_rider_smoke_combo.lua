fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				property_00 =  
				{
					name = "Fx1",
					type = "VARTYPE_STRING",
					value = "guard_rider_smoke_spray",
				},
				property_01 =  
				{
					name = "Fx2",
					type = "VARTYPE_STRING",
					value = "guard_rider_smoke_trial",
				},
				property_02 =  
				{
					name = "FX3",
	...
	{
		effect = "root>guard_rider_smoke_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>guard_rider_smoke_spray>veh_smoke_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>guard_rider_smoke_trial",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "GUARD/ABILITIES/RIDER_TRAIL.DDS",
				},
				property_04 =  
				{
					name = "ColourHead",
