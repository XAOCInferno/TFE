fxtypes =  
{
	...
	{
		effect = "root>venomprospray>venompro",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>venomspitspray>venomspit2",
		fx =  
		{
			properties =  
			{
