fxtypes =  
{
	...
	{
		effect = "root>poison_burst_direct",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "SKINNIE_TEXTURES/GREY_SPLASH/POISON_FX_PC_BURST_1_NO_COLOR_BRIGHT.DDS",
				},
				property_04 =  
				{
					name = "Offset",
	...
	{
		effect = "root>ight_combo>unit_battlecry_halo_light",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>green_burst>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>impact_blood_single_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>impact_blood_single_combo>impact_blood_1_beam",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "SKINNIE_TEXTURES/GREY_SPLASH/POISON_FX_PC_BURST_2_NO_COLOR_BRIGHT.DDS",
				},
				property_04 =  
				{
					name = "Offset",
