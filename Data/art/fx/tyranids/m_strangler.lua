fxtypes =  
{
	...
	{
		effect = "root>barbedmuzzle>stranglermuzzle",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES/BARBEDMUZZLE.TGA",
				},
				property_04 =  
				{
					name = "Offset",
	...
	{
		effect = "root>bloodspray2>blood2",
		fx =  
		{
			properties =  
			{
