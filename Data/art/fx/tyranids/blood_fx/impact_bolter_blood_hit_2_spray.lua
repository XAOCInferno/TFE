fxtypes =  
{
	...
	{
		effect = "root>impact_blood_single_2_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>impact_blood_single_2_combo>impact_blood_2_beam",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "SKINNIE_TEXTURES/GREY_SPLASH/SPLASH_FX_PC_BURST_2.TGA",
				},
				property_04 =  
				{
					name = "Offset",
	...
	{
		effect = "root>impact_blood_single_2_combo>impact_blood_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "SKINNIE_TEXTURES/GREY_SPLASH/SPLASH_FX_PC_CLOUD_1.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
