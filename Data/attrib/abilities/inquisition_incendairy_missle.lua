...
GameData["child_ability_name"] = [[inquisition_incendairy_missle_flames]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020541]] -- - Fires an incendairy missle at the Targeted location.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020542]] -- - Left-click and target a location or enemy squad or an enemy building to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020543]] -- - Causes the ground to burn dealing damage overtime to enemies inside the flames.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/ability_hk_missile]]
GameData["ui_info"]["screen_name_id"] = [[$16020540]] -- Incendairy Missle
