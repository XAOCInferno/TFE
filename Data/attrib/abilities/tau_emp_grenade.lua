...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"] = Reference([[modifiers\enable_screaming_jets.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\tau_stealth_suit_damage_research.lua]]
