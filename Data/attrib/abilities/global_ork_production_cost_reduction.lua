...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\global_ork_production_cost_reduction_entity.lua]]
...
GameData["ui_info"]["icon_name"] = [[Ork_Icons/global_ability_production_cost_reduction]]
