...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18010220]] -- - Daemonic chains entangle an enemy squad.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18010222]] -- - Left-click and target an enemy squad to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18010223]] -- - Prevents the squad from moving for a short period of time.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18010223]] -- - Does minor damage.
GameData["ui_info"]["icon_name"] = [[ork_icons/ability_stab_em]]
GameData["ui_info"]["screen_name_id"] = [[$18010219]] -- Chains of Torment
