...
--[[GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[races/dark_eldar/ability/dark_eldar_FoF]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[races/dark_eldar/ability/dark_eldar_FoF]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[races/dark_eldar/ability/dark_eldar_FoF]]]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 0.82
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["max_lifetime"] = 8
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\ability_speed_fiend_event.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[dark_eldar_fleet_research]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18010177]] -- - Boost Eldar running speed.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18010178]] -- - Left-click to activate.  Left-click again to deactivate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18010179]] -- - Increases movement speed while active.
GameData["ui_info"]["icon_name"] = [[dark_eldar_icons/dark_eldar_fleet]]
GameData["ui_info"]["screen_name_id"] = [[$18010176]] -- Fleet of Foot
