...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\global_ork_feral_boyz_entity.lua]]
...
GameData["ui_info"]["icon_name"] = [[Ork_Icons/global_ability_feral_boyz_summon]]
