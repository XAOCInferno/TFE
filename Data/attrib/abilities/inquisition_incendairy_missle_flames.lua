...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_12"] = Reference([[type_armour\tp_sub_commander.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_13"] = Reference([[type_armour\tp_daemon_high.lua]])
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_14"] = Reference([[type_armour\tp_daemon_med.lua]])
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_10"]["armour_type"] = Reference([[type_armour\tp_sub_commander.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$91512]] -- - Fires an incendairy missle at the trageted location.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$91513]] -- - Left-click and target a location or enemy squad or an enemy building to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16023047]] -- - Causes the ground to burn dealing damage overtime to enemies inside the flames.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/ability_hk_missile]]
GameData["ui_info"]["screen_name_id"] = [[$16023046]] -- Incendiary Missle
