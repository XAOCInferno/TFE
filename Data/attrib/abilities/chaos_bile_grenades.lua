...
GameData["area_effect"]["area_effect_information"]["radius"] = 3.15
...
GameData["projectile_name"] = [[bile_grenade]]
...
GameData["requirements"]["required_10"]["research_name"] = [[research\chaos_csm_mark_nurgle_research.lua]]
