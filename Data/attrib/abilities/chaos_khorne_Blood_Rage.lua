...
--[[GameData["area_effect"]["area_effect_information"]["area_effect_events"]["dirtsand"] = [[races\chaos\abilities\worship_fx\worship_mark_khorne]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["grass"] = [[races\chaos\abilities\worship_fx\worship_mark_khorne]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["rock"] = [[races\chaos\abilities\worship_fx\worship_mark_khorne]]
GameData["area_effect"]["area_effect_information"]["area_effect_events"]["water"] = [[races\chaos\abilities\worship_fx\worship_mark_khorne]]]]
...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[races\chaos\abilities\khorne_blood_rage]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[races\chaos\abilities\khorne_blood_rage]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[races\chaos\abilities\khorne_blood_rage]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[races\chaos\abilities\khorne_blood_rage]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["surface"] = Reference([[type_surface\tp_monolith.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\life_leech_damage_modifier.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\life_leech_damage_modifier.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"] = Reference([[modifiers\health_get_back_up_modifier.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"] = Reference([[tables\time_modify_entry.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\chaos_berserker_fear_research_new.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18010080]] -- Followers of Khorne revel in close combat. Release their rage to slaughter even the strongest foes in the name of Khorne, and inspire the others to fight harder.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18010081]] -- |
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18010082]] -- - Life Leech: +250% 
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18010083]] -- - Life Leech (secondary): +1.5
GameData["ui_info"]["help_text_list"]["text_05"] = [[$18010084]] -- - Base Speed: +30%
GameData["ui_info"]["help_text_list"]["text_06"] = [[$18010085]] -- - Health Degeneration: +5
GameData["ui_info"]["help_text_list"]["text_07"] = [[$18010086]] -- - Get Back Up Time: -50%
GameData["ui_info"]["help_text_list"]["text_08"] = [[$18010087]] -- - Radius 15 / Duration 12.5s / Cooldown 120s
GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_marine_icon_berserker_fear]]
GameData["ui_info"]["screen_name_id"] = [[$18010079]] -- Khornate Frenzy
