...
GameData["execute_table"]["executable_troopers"]["trooper_01"] = [[ebps\races\chaos\troops\chaos_aspiring_champion.lua]]
...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\chaos_tzeentch_portal.lua]]
