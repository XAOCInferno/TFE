...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\global_ork_cult_of_speed_entity.lua]]
...
GameData["ui_info"]["icon_name"] = [[Ork_Icons/global_ability_cult_of_speed]]
