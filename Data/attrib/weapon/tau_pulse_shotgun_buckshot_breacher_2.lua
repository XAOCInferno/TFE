GameData = Inherit([[weapon\tau_pulse_shotgun_buckshot_breacher_1.lua]])
...
GameData["area_effect"]["area_effect_information"]["radius_change_for_child_weapons"] = GameData["area_effect"]["area_effect_information"]["radius_change_for_child_weapons"] + GameData["area_effect"]["area_effect_information"]["radius_change_for_child_weapons"]
