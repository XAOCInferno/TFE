GameData = Inherit([[]])
GameData["accuracy"] = 0.3
GameData["accuracy_reduction_when_moving"] = 0.175
...
GameData["area_effect"]["area_effect_information"]["radius"] = 3.25
...
GameData["horizontal_traverse_speed"] = 225
