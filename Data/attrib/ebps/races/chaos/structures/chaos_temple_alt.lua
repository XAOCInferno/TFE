...
GameData["research_ext"]["research_table"]["research_01"] = [[research\chaos_csm_mark_khorne_research.lua]]
...
GameData["spawner_ext"]["squad_table"]["squad_01"] = [[sbps\races\chaos\chaos_AL_Psyker_Squad.lua]]
