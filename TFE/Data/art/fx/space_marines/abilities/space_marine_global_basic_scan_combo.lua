fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_16 =  
				{
					name = "Particle_Fx",
					type = "VARTYPE_STRING",
					value = "detection_field_cursor_02",
				},
				property_17 =  
				{
	...
	{
		effect = "root>spray_default>detection_field_cursor_02",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>spray_default>detection_field_cursor_02>pulse_ring_01",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>spray_default>detection_field_cursor_02>pulse_ring_02",
		fx =  
		{
			properties =  
			{
