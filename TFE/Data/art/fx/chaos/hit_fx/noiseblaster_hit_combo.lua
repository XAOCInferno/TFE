fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				property_00 =  
				{
					name = "Fx1",
					type = "VARTYPE_STRING",
					value = "noiseblaster_hit_spray",
				},
				property_01 =  
				{
					name = "Fx2",
					type = "VARTYPE_STRING",
					value = "noiseblaster_hit_ring",
				},
				property_02 =  
				{
					name = "FX3",
	...
	{
		effect = "root>noiseblaster_hit_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>noiseblaster_hit_spray>noiseblaster_hit_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES/A_SLAANICON_FLIP.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>noiseblaster_hit_ring",
		fx =  
		{
			properties =  
			{
