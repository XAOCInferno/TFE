fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_16 =  
				{
					name = "Particle_Fx",
					type = "VARTYPE_STRING",
					value = "barbed_strangler_projectile_edit",
				},
				property_17 =  
				{
	...
	{
		effect = "root>barbed_strangler_projectile_edit",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>barbed_strangler_projectile_edit>default_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>barbed_strangler_projectile_edit>default_spray>default_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>barbed_strangler_projectile_edit>flash_glow",
		fx =  
		{
			properties =  
			{
