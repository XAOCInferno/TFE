...
GameData["research_ext"]["research_table"]["research_01"] = [[research\tyranids_tyrant_guard_health.lua]]
...
GameData["ui_ext"]["ui_info"]["icon_name"] = [[tyranid_icons/structure_basic_vehicles_icon]]
