...
GameData["research_ext"]["research_table"]["research_01"] = [[research\sisters_martyrs_gift.lua]]
...
GameData["spawner_ext"]["squad_table"]["squad_06"] = [[sbps\races\sisters\sisters_squad_canoness_advance_sp.lua]]
