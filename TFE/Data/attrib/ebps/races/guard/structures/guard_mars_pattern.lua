...
GameData["addon_ext"]["addons"]["addon_01"] = [[addons\addon_guard_lemanruss_depot.lua]]
...
GameData["spawner_ext"]["squad_table"]["squad_02"] = [[sbps\races\guard\guard_squad_lemanruss.lua]]
