...
GameData["requirements"]["required_9"]["structure_name_either"] = [[ebps\races\tau\structures\tau_shrine_of_kauyon.lua]]
GameData["requirements"]["required_9"]["structure_name_or"] = [[ebps\races\tau\structures\tau_shrine_of_montka.lua]]
