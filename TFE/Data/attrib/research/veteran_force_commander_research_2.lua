...
GameData["requirements"]["required_1"]["research_name"] = [[veteran_marine_force_commander_ability_research_1]]
GameData["requirements"]["required_2"] = Reference([[requirements\global_required_addon.lua]])
GameData["requirements"]["required_2"]["global_addon_name"] = [[veteran_hq_addon_2]]
GameData["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["requirements"]["required_10"]["research_name"] = [[veteran_marine_force_commander_ability_research_1]]
