...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["target_type_name"]  = [[eliminator_scout]]
...
GameData["child_ability_name"] = [[marines_eliminator_snipe02]]
