...
GameData["requirements"]["required_11"]["squad_name"] = [[world_squad_global_ability_caster_guard_race]]
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\global_guard_valkyrie_reinforce_entity.lua]]
