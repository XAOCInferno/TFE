...
--[[GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[generic/blackstone_hex_event]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[generic/blackstone_hex_event]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[generic/blackstone_hex_event]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[generic/blackstone_hex_event]]]]
