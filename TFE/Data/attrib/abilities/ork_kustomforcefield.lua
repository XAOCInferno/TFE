...
GameData["area_effect"]["area_effect_information"]["target_filter"]["entry_03"] = Reference([[type_armour\tp_sub_commander.lua]])
...
GameData["child_ability_name"] = [[ork_kustomforcefield_2]]
