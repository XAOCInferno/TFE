...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\tyranids_hive_tyrant_force_upgrade_talons_bottom_entity.lua]]
...
GameData["ui_info"]["icon_name"] = [[tyranid_icons/tyranids_upgrade_scything_talons]]
