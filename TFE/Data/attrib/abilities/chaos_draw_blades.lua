...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[races/chaos/abilities/chaos_draw_blades]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[races/chaos/abilities/chaos_draw_blades]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[races/chaos/abilities/chaos_draw_blades]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[races/chaos/abilities/chaos_draw_blades]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"]["value"] = 1.40000
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"] = Reference([[modifiers\enable_shooting.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\morale_maximum_squad_modifier.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"]["value"] = 1.2
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["modifier"]["max_lifetime"] = 1
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["modifier"] = Reference([[modifiers\enable_squad_morale_damage.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_09"]["modifier"]["value"] = 0.9
...
GameData["recharge_timer_id"] = 021
GameData["refresh_time"] = 10
GameData["requirements"] = Reference([[tables\requirements.lua]])
GameData["requirements"]["required_1"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_1"]["research_name"] = [[research\chaos_csm_mark_khorne_research.lua]]
GameData["requirements"]["required_10"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["requirements"]["required_10"]["research_name"] = [[research\chaos_csm_mark_khorne_research.lua]]
...
GameData["ui_info"]["help_text_id"] = [[]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18010026]] -- The horrors of existence within the Eye of Terror has melded and broken the souls of even the most resilient traitor. For a Chaos Marine, there is no greater pleasure than slaughtering the enemy face-to-face. Unleash their unholy fury and draw their blades! 
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18010027]] -- |
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18010028]] -- - Morale Regen: Increased by 4/s
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18010029]] -- - Speed: Increase of 35%
GameData["ui_info"]["help_text_list"]["text_05"] = [[$18010030]] -- - Tactical Knives DPS increase of 40%
GameData["ui_info"]["help_text_list"]["text_06"] = [[$18010031]] -- - Disables Shooting
GameData["ui_info"]["help_text_list"]["text_07"] = [[$18010032]] -- - Duration: 10s / Cooldown: 90s
GameData["ui_info"]["icon_name"] = [[chaos_icons/chaos_draw_blades_icon]]
GameData["ui_info"]["screen_name_id"] = [[$18010025]] -- Draw Blades!
