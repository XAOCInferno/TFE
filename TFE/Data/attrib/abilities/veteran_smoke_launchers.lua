GameData = Inherit([[]])
GameData["ability_cursor_event"] = [[markers/marine_smoke_launcher_start]]
...
GameData["requirements"]["required_1"]["research_name"] = [[research\veteran_smoke_launcher_research.lua]]
