...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18010214]] -- - Daemonic chains entangle an enemy squad.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18010215]] -- - Left-click and target an enemy squad to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18010216]] -- - Prevents the squad from moving for a short period of time.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18010217]] -- - Does minor damage.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$18010218]] -- - Does not affect vehicles.
GameData["ui_info"]["icon_name"] = [[ork_icons/ability_hide_da_boys]]
GameData["ui_info"]["screen_name_id"] = [[$18010213]] -- Chains of Torment
