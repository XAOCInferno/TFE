...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020553]] -- - Restore Up to 90% of Orbital Strikes Cooldown.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020554]] -- - Call on Addtional Orbital Strikes to be made from the orbital fleet
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020555]] -- - Carrying out such orders will require certain Amount of resources to be invested.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020977]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/rally_ability]] 
GameData["ui_info"]["screen_name_id"] = [[$16020552]] -- Extended Orbital Bombing Operations
