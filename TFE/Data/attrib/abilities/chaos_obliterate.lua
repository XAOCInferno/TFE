...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 0.777
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"] = Reference([[modifiers\morale_break_event_space_marine.lua]])
...
GameData["requirements"]["required_1"]["research_name"] = [[research\chaos_personalteleporters.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$18010202]] -- [FLAVOUR TEXT DESC - DAKKA?|Ogryn]
GameData["ui_info"]["help_text_list"]["text_02"] = [[$18010203]] -- |
GameData["ui_info"]["help_text_list"]["text_03"] = [[$18010204]] -- - Reload Speed: -90%
GameData["ui_info"]["help_text_list"]["text_04"] = [[$18010205]] -- - Duration 12.5 / Cooldown 120s
GameData["ui_info"]["icon_name"] = [[chaos_icons/ability_obliterate]]
GameData["ui_info"]["screen_name_id"] = [[$18010201]]-- Dakka?
