...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\chaos_sorcerer_multi_use_teleportation_node_entity.lua]]
...
GameData["ui_info"]["icon_name"] = [[chaos_icons/ability_multi_teleport]]
