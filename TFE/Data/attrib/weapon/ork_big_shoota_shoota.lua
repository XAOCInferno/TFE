GameData = Inherit([[]])
GameData["accuracy"] = 0.38
GameData["accuracy_reduction_when_moving"] = 0.28
...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"] = Reference([[tables\piercings\Ranged_Shoota_Big.lua]])
