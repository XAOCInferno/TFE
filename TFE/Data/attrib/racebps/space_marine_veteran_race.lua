...
GameData["race_details"]["name_id"] = [[$20020000]] -- Space Marines
GameData["race_details"]["playable"] = false
GameData["race_path"] = Reference([[tables\race_path.lua]])
GameData["race_path"]["building_path"] = [[Races/Space_Marines_Veteran/Structures]]
GameData["race_path"]["projectile_path"] = [[Races/Space_Marines_Veteran/Projectiles]]
GameData["race_path"]["speech_path"] = [[Speech/Races/Space_Marines/Shared]]
GameData["race_path"]["squad_path"] = [[Races/Space_Marines_Veteran]]
GameData["race_path"]["taskbar_path"] = [[Space_Marines]]
GameData["race_path"]["unit_path"] = [[Races/Space_Marines_Veteran/Troops]]
...
GameData["starting_buildings"]["building_01"] = [[space_marine_hq_veteran]]
...
GameData["starting_squads"]["squad_01"] = [[space_marine_squad_servitor_veteran]]
GameData["teamcolour_preview"] = Reference([[tables\race_teamcolour_preview_entities.lua]])
GameData["teamcolour_preview"]["entity_01"] = [[space_marine_veteran_tactical_bolter]]
GameData["teamcolour_preview"]["entity_02"] = [[assault_marine_veteran]]
